...
## Step-02: 2-variables.tf - Define Input Variables in Terraform
...
## Step-03: c-ec2securitygroups.tf - Define Security Group Resources in Terraform
...
## Step-04: 4-ami-datasource.tf - Define Get Latest AMI ID for Amazon Linux2 OS
...
```
- Reference the datasource in `5-ec2instance.tf` file
```t
# Reference Datasource to get the latest AMI ID
ami = data.aws_ami.amzlinux2.id 
```

## Step-05: 5-ec2instance.tf - Define EC2 Instance Resource
...
## Step-06: 6-outputs.tf - Define Output Values 
...
http://<PUBLIC-IP>/app/index.html

# Access metadata.html
http://<PUBLIC-IP>/app/metadata.html
```
